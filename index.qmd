...
## OLS: el resultado central persiste al condicionar
...
## Estabilidad de la tenencia entre especificaciones

::: {.columns}
::: {.column width="54%"}
![](assets/figuras/coef_progresivos.png)
:::
::: {.column width="46%"}
![](assets/figuras/predicciones.png)
:::
:::

<div class="key-message">
El orden sustantivo no desaparece al incorporar escala, características sociodemográficas y tecnología.
</div>
...
## Heterogeneidad provincial después de controlar covariables

![](assets/figuras/caterpillar.png){fig-align="center"}

<div class="source-note">Cada punto representa la desviación provincial estimada respecto del promedio general, con intervalos condicionales.</div>
...
## Resultado decisivo: convergencia entre métodos

![](assets/figuras/coefplot.png){fig-align="center"}
